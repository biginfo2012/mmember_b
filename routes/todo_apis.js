...
router.get("/today_taskread/:userId/:page_no/:per_page", verifySchool, todos.today_taskread)
router.get("/weekTaskRead/:userId/:page_no/:per_page", verifySchool, todos.weekTaskRead)
