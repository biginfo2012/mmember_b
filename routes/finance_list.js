...
const { monthly_pay,exp_break,income_break,cc_expire,membership ,this_month}  = require("../controllers/finance_list")
const { requireSignin,isAuth,verifySchool } = require("../controllers/auth");

router.get("/finance/monthly_pay_list/:userId",verifySchool,monthly_pay)
router.get("/finance/thisMonth/:userId",verifySchool,this_month)
