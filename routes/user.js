...
router.put(
  "/sendgridverification/emails/:userId",
  requireSignin,
  verificationLink
);
router.get(
  "/getsendgridverification/:userId",
  requireSignin,
  listingVerifications
);
router.delete(
  "/delete/verifiedsendgriduser/:userId/:email",
  requireSignin,
  deleteVerifiedSendgridUser
);
