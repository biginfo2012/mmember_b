const { OtpMailer } = require("../helpers/otpMailer");

async function sendEmailVerification(receipent, otp) {
  try {
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                    <tr> 
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                        ...
                        <tr> 
                          <td align="center" style="padding:0;Margin:0;padding-bottom:35px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#333333;font-size:12px">mymember © 2022&nbsp;All Rights Reserved.<br></p></td> 
                        </tr> 
                      </table></td> 
                    </tr> 
                  </table></td> 
  ...
  `;
    await OtpMailer(receipent, verificationBody);
    console.log("Sending OTP to Email...");
  } catch (error) {
    console.log("Something wrong! Email OTP not Send!");
  }
}
